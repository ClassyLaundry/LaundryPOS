                    ...
                    <div class="p-3 border rounded" style="border: 1px solid rgba(0,0,0,.125);">
                        ...
                        <div class="hub-list hub-karyawan">
                            ...
                            @if ($transaksi->status != 'done' && $transaksi->pencuci == Auth::id() && !$transaksi->setrika_only)
                                <div
                                    @if ($transaksi->is_done_cuci == 1)
                                    class="border rounded mt-3" style="border-bottom: 3px solid rgb(54, 162, 235)!important; background-image: linear-gradient(to bottom right, white, rgb(54, 162, 235, .5)); background-color: white;"
                                    @else
                                    class="border rounded mt-3 item" style="border-bottom: 3px solid rgb(54, 162, 235)!important; background-color: white;"
                                    @endif
                                >
                                    <div class="p-3 border-bottom rounded d-flex justify-content-between align-items-center">
                                        <div class="d-flex flex-column">
