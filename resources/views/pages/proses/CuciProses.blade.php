...
<div class="container">
    ...
    <ul role="tablist" class="nav nav-tabs border-bottom-0">
        ...
        <li role="presentation" class="nav-item"><a role="tab" data-bs-toggle="tab" class="nav-link" href="#tab-2">Pencuci</a></li>
        ...
        <div class="card">
            <div class="card-body pb-0">
                ...
                <div role="tabpanel" class="tab-pane" id="tab-2">
                    <div class="list-container" id="hub-pencuci"></div>
                </div>
...
<script src="{{ asset('js/proses/cuciProses.js') }}"></script>
@endsection
