...
@section('content')
    <div class="container">
        <header class="d-flex align-items-center my-3" style="color: var(--bs-gray);"><a>Master Data</a><i
                class="fas fa-angle-right mx-2"></i><a>Data Pelanggan</a></header>
                        ...
                        <div class="row">
                            <div class="col-12 mb-2">
                                ...
                                <input class="form-control" type="text" id="input-nama-pelanggan" name="nama"
                                    value="{{ $pelanggan->nama }}" required disabled>
                            </div>
                            <div class="col-12 col-lg-4 mb-2">
                                <h5>Tanggal Lahir</h5>
                                <input class="form-control" id="input-tanggal-lahir" type="date" name="tanggal_lahir"
                                    value="{{ $pelanggan->tanggal_lahir }}" disabled>
                            </div>
                            <div class="col-12 col-lg-4 mb-2">
                                <h5>Jenis Kelamin</h5>
                                <div class="form-control d-flex align-items-center justify-content-around">
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="formCheck-pria" name="gender"
                                            value='pria' @if ($pelanggan->gender == 'pria') checked @endif required
                                            disabled />
                                        <label class="form-check-label" for="formCheck-pria">Pria</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="formCheck-wanita" name="gender"
                                            value='wanita' @if ($pelanggan->gender == 'wanita') checked @endif disabled />
                            ...
                            <div class="col-12 col-lg-4 mb-2">
                                ...
                                <div class="form-control d-flex align-items-center justify-content-around">
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="formCheck-member" name="member"
                                            value=1 @if ($pelanggan->member) checked @endif required disabled />
                                        <label class="form-check-label" for="formCheck-member">Member</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="formCheck-non-member"
                                            name="member" value=0 @if (!$pelanggan->member) checked @endif
                                            disabled />
                            ...
                            @if (Session::get('role') == 'administrator')
                                <div class="col-12 col-md-4 mb-2">
                                    ...
                                    <input class="form-control" type="text" id="input-telepon" name="telephone"
                                        value="{{ $pelanggan->telephone }}" required
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                        disabled>
                                </div>
                                <div class="col-12 col-md-4 mb-2">
                                ...
                                <div class="col-12 col-md-4 mb-2">
                                    ...
                                    <input class="form-control" type="text" id="input-diskon" name="diskon"
                                        value="{{ $pelanggan->diskon }}" disabled>
                                </div>
                            @else
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <textarea class="form-control" id="input-catatan-khusus" name="catatan_khusus" disabled>
@isset($catatan->catatan_khusus)
        ...
        @if (in_array('Membuka Menu Pembayaran', Session::get('permissions')) || Session::get('role') == 'administrator')
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Pembayaran <span class="kode-trans">kode trans</span></h4>
                                    ...
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-9 mb-4">
                                                <input type="text"
                                                    class="form-control h-100 extra-large disabled input-thousand-separator"
                                                    id="input-total" value="{{ $pelanggan->tagihan }}" />
                                            </div>
                                            <div class="col-3 mb-2">
                                                <p class="d-flex align-items-center justify-content-end"
                                                    style="height: 38px;">Metode Pembayaran :</p>
                                            </div>
                                            ...
                                            <div class="col-3 mb-2">
                                                <p class="d-flex align-items-center justify-content-end"
                                                    style="height: 38px;">Nominal :</p>
                                            </div>
                                            <div class="col-9 mb-2">
                                                <input type="text" class="form-control input-thousand-separator"
                                                    id="input-nominal"
                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                                    name="nominal" required />
                                            </div>
                                            <div class="col-3 mb-2">
                                                <p class="d-flex align-items-center justify-content-end fw-bold"
                                                    style="height: 38px;">Kembali :</p>
                                            </div>
                                            <div class="col-9 mb-2">
                                                <input type="text"
                                                    class="form-control disabled input-thousand-separator"
                                                    id="input-kembalian" />
                                            </div>
                                            <input type="hidden" id="input-pelanggan" name="pelanggan_id"
                                                value="{{ $pelanggan->id }}" />
                                        </div>
                                    </div>
                    ...
                    @if (in_array('Melihat Detail History Transaksi Pelanggan', Session::get('permissions')) ||
                    ...
                    @if (in_array('Melihat Detail History Saldo Pelanggan', Session::get('permissions')) ||
                            Session::get('role') == 'administrator')
                        <hr>
