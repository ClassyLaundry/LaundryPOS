$(document).ready(function() {
    ...
    $('#table-history-transaksi').load(window.location.origin + '/pelanggan/' + id + '/history/transaksi');
    $('#table-history-saldo').load(window.location.origin + '/pelanggan/' + id + '/history/saldo?order=desc');
